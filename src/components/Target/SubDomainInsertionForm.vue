                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-container">
                                <div v-for="(item, index) in subdomains" :key="item" class="subdomain-form-container mt-2">
                                  <input :data-index="index" v-model="item.name" @keyup.enter="createSubdomains" class="rounded-corners form-control agent-placeholder subdomains-items-field" placeholder="New subdomain" @blur="enableValidationMessageSubDomainBlankName" @keyup="enableValidations">
                                  <div style="height: 0;">
