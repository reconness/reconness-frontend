export default ({
  ...
  state: {
    targetListStore: [
      { id: 1, name: 'My target 1', background: 'transparent linear-gradient(135deg, #03dced 0%, #0cb8e0 100%) 0% 0% no-repeat padding-box', date: '02/01/2020', rootDomains: [{ id: 1, root: 'reconnes.com' }, { id: 2, root: 'anotherness.com' }] },
      { id: 2, name: 'My target 2', background: 'transparent linear-gradient(135deg, #03dced 0%, #0cb8e0 100%) 0% 0% no-repeat padding-box', date: '21/01/2020', rootDomains: [{ id: 1, root: 'reconnes.com' }, { id: 2, root: 'anotherness.com' }, { id: 2, root: 'anothertest1.com' }, { id: 2, root: 'anothertest2.com' }] },
      { id: 3, name: 'My target 3', background: 'transparent linear-gradient(160deg, #F96767 0%, #FF4343 100%) 0% 0% no-repeat padding-box', date: '21/02/2020', rootDomains: [{ id: 1, root: 'reconnes.com' }, { id: 2, root: 'anotherness.com' }] },
      { id: 4, name: 'My target 4', background: 'transparent linear-gradient(135deg, #03dced 0%, #0cb8e0 100%) 0% 0% no-repeat padding-box', date: '21/04/2020', rootDomains: [{ id: 1, root: 'reconnes.com' }, { id: 2, root: 'anotherness.com' }] },
      { id: 5, name: 'My target 5', background: 'transparent linear-gradient(135deg, #3adb99 0%, #16c465 100%) 0% 0% no-repeat padding-box', date: '21/02/2018', rootDomains: [{ id: 1, root: 'reconnes.com' }, { id: 2, root: 'anotherness.com' }] },
